      ...
      <mat-card>
        <div id="html">
          <div>
            ...
            <p class="margin" style="text-align:center;font-size:15px;color:#767270;word-break:break-word;">
            ...
            <h4 style="color:#538ec3;text-align:center;"><i class="fa fa-envelope" aria-hidden="true"></i>
