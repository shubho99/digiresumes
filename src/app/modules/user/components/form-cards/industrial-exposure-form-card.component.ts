...
@Component({
  selector: 'app-industrial-exposure-form-card',
  template: `
    <div style="position: relative" fxLayoutAlign="center center" fxLayout="column">
      ...
      <div style="position: absolute; top: 74.5%; right: -7.5%;" fxLayoutAlign="start center" fxHide.gt-xs>
...
export class IndustrialExposureFormCardComponent {
